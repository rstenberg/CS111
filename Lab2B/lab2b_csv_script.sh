...
./lab2_list --threads=8  --iterations=8   --yield=dl >> lab2b_list.csv
...
# check multi-list correctness (no-sync)
...
# check multi-list correctness (mutex)
...
# check multi-list correctness (spin)
...
# performance check for partitioned list (w/ syncs)
